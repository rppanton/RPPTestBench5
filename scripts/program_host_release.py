##########################################################################################
# Programm v7 Badge boards release host application
#
...
while True:
	...
	try:
		...
		# jlink.reset()
		filename = app.softdev_r_file.currentText()

		print "\t* Load release application file for {}: {}".format(desc.HostFamily, filename)
